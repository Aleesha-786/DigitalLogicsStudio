...
const syntheticProblems = [
  ...
  },
  {
    ...
    difficulty: "Medium",
    tags: ["Number Systems", "Arithmetic", "Arithmetic Functions", "Digital Logic"],
    description: "Determine when signed binary addition overflows and identify the final carry and interpreted decimal result.",
  ...
  },
  {
    ...
    difficulty: "Medium",
    tags: ["Registers", "RTL", "Registers & Transfers", "Digital Logic"],
    description:
      "Given the conditional register transfers P: R2 ← R1 and Q: R3 ← R2 + 1, " +
      "which control-signal combination transfers R1 into R2 AND increments the OLD R2 into R3 in the same cycle?",
    ...
    hint: "Translate each condition into a gated transfer and check data dependencies. Note both transfers use the OLD value of R2 in the same cycle (non-blocking style) — R3 does not see the newly loaded R1.",
    inputs: ["P", "Q", "CLK"],
    outputs: ["R2 (next)", "R3 (next)"],
    isSynthetic: true,
    type: "mcq",
    options: ["P=0, Q=0", "P=1, Q=0", "P=0, Q=1", "P=1, Q=1"],
  ...
  },
  {
    ...
    difficulty: "Easy",
    tags: ["Memory Systems", "Decoder", "Digital Logic"],
    description: "Map a binary address space to word lines and identify which decoder outputs activate each memory row.",
    equations: ["Word_i = Decoder(A)"],
    truthTable: [
      { A2: 0, A1: 0, A0: 0, W0: 1, W1: 0, W2: 0, W3: 0, W4: 0, W5: 0, W6: 0, W7: 0 },
      { A2: 0, A1: 0, A0: 1, W0: 0, W1: 1, W2: 0, W3: 0, W4: 0, W5: 0, W6: 0, W7: 0 },
      { A2: 0, A1: 1, A0: 0, W0: 0, W1: 0, W2: 1, W3: 0, W4: 0, W5: 0, W6: 0, W7: 0 },
      { A2: 0, A1: 1, A0: 1, W0: 0, W1: 0, W2: 0, W3: 1, W4: 0, W5: 0, W6: 0, W7: 0 },
      { A2: 1, A1: 0, A0: 0, W0: 0, W1: 0, W2: 0, W3: 0, W4: 1, W5: 0, W6: 0, W7: 0 },
      { A2: 1, A1: 0, A0: 1, W0: 0, W1: 0, W2: 0, W3: 0, W4: 0, W5: 1, W6: 0, W7: 0 },
      { A2: 1, A1: 1, A0: 0, W0: 0, W1: 0, W2: 0, W3: 0, W4: 0, W5: 0, W6: 1, W7: 0 },
      { A2: 1, A1: 1, A0: 1, W0: 0, W1: 0, W2: 0, W3: 0, W4: 0, W5: 0, W6: 0, W7: 1 },
    ],
    hint: "Each address activates exactly one word line in a basic RAM array.",
    inputs: ["A2", "A1", "A0"],
    outputs: ["W0", "W1", "W2", "W3", "W4", "W5", "W6", "W7"],
  },
  {
    id: 2007,
